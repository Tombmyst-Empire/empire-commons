...
from empire.commons.sorting_util import SortingUtil
...
def test_sort_dict_list_by_another_list():
    ...
    assert SortingUtil.sort_dict_list_by_another_list(
        l1,
        l2,
        'a'
    ...
    with pytest.raises(KeyError):
        SortingUtil.sort_dict_list_by_another_list(
            l1, l2, 'rogers'
        )
...
def test_sort_object_list_by_another_list():
    ...
    assert SortingUtil.sort_object_list_by_another_list(
        l1,
        l2,
        'a'
    ...
    with pytest.raises(AttributeError):
        SortingUtil.sort_object_list_by_another_list(
            l1, l2, 'rogers'
        )
